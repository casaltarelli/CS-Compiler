...
**Prof. Labouseur**
Please grade my Project Three on the main branch of this project. Safari seems to hate assertions (working on that one), please run my project in [Google Chrome](https://www.google.com/chrome/) to avoid any issues. 
