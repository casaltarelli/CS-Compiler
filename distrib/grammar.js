...
var _Grammar = [
    ...
    { priority: 1, name: "L_COMM", regex: /^\/\*/, action: function (lexeme) { _Lexer.inComment = true; } },
    { priority: 1, name: "R_COMM", regex: /^\*\//, action: function (lexeme) { _Lexer.inComment = false; } },
    ...
    { priority: 0, name: "SPACE", regex: /^\s/, action: function (lexeme) { if (_Lexer.inQuote) {
            _Lexer.emitToken(_Lexer.generateToken(this.name, lexeme));
        } } }
];
